...
function rfsFitViewport() {
  ...
  document.getElementById('rfs-viewport-scale').style.transform = 'scale(' + scale + ')';

  /* nav-overlay는 rfs-viewport-scale 안에 중첩되어 함께 스케일되므로, 스케일 후에도
...
requestAnimationFrame(rfsFitViewport);
